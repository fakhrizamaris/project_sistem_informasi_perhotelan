  ...
  <nav class="navbar navbar-expand-lg site-nav">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item"><a class="nav-link" style="font-weight:bold; font-family: georgia bold; font-size: 20px;" href="about.php">About</a></li>
          <li class="nav-item"><a class="nav-link" style="font-weight:bold; font-family: georgia bold; font-size: 20px;" href="index.php">Home</a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <section class="suite-section">
        ...
        <div class="suite-content">
            <h1>Suite</h1>
            <p>Suite Room offers a luxurious stay with 65 m² of space, featuring a separate living area, an elegant
                bedroom with a King Size bed, and a private balcony overlooking the city. The modern bathroom includes a
                bathtub and separate shower, premium toiletries, and exclusive bathrobes. Guests can also enjoy a
                55-inch flat-screen TV, minibar, complimentary high-speed Wi-Fi, and 24-hour room service for an
                unforgettable stay.</p>

            <div class="features">
                <div><i class="fa-solid fa-bed"></i> King Size Bed</div>
                <div><i class="fa-solid fa-bath"></i> Bathtub & shower separate</div>
            ...
            <div class="price">IDR 3.000.000 / night</div>
