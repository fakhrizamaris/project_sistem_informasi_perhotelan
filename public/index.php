...
.book-btn {
  ...
  font-family: georgia;
  font-size: 30px;
  background-color: #A69C67; /* hijau emerald gelap */
  color: white;
...
.book-btn:hover {
  background-color: #50C878; /* hijau emerald terang */
}
.custom-section {
  background-color: #012A2A; /* hijau tua */
  padding: 50px 20px;
  color: white;
  text-align: center;
}
...
.logo-text {
  ...
  font-weight: bold;
  color: #A69C67;
  font-family: cursive; /* bisa diganti sesuai selera */
}
...
.site-header {
  ...
  z-index: 9999; /* tinggi agar selalu di atas */
  width: 100%;
}
...
.top-bar {
  ...
  align-items: center;
  padding: 10px 24px;
  background: rgba(255,255,255,0.95); /* transparan tipis, ubah sesuai selera */
  border-bottom: 1px solid rgba(0,0,0,0.06);
}

/* tombol book */
.book-btn {
  background-color: /* bikin header tetap di atas layar */
.site-header {
  position: fixed;
  top: 0;
  left: 0;
...
body { padding-top: 110px; } /* sesuaikan jika headermu lebih tinggi */
;
  color: white;
  padding: 8px 16px;
  border-radius: 6px;
